...
export const Register = () => {
    ...
    const validate = (values) => {
        ...
        if (!values.confpassword) {
            errors.confpassword = "confpassword required";
        }
        else if (values.password !== values.confpassword) {
            errors.confpassword = "password and confpassword must be the same"
        }
        return errors;
                ...
                <div className="formBx">
                    ...
                    <form>
                        ...
                        <div className="inputBx">
                            ...
                            <Link to='/' style={{ textDecoration: 'none', color: 'black' }} ><button type="submit" value="submit"
                                id="submit" onClick={submit}>Sign up</button></Link>
                            <br></br>
                            Already Register?
